...
void Log::logHeartBeat(Address *thisNode, Address *addedAddr) {
	static char stdstring[100];
	sprintf(stdstring, "Node %d.%d.%d.%d:%d hearbeat at %d", addedAddr->addr[0], addedAddr->addr[1], addedAddr->addr[2], addedAddr->addr[3], *(short *)&addedAddr->addr[4], par->getcurrtime());
	LOG(thisNode, stdstring);
}

void Log::logJoinRep(Address *thisNode, Address *addedAddr) {
	static char stdstring[100];
	sprintf(stdstring, "Node %d.%d.%d.%d:%d rep at %d", addedAddr->addr[0], addedAddr->addr[1], addedAddr->addr[2], addedAddr->addr[3], *(short *)&addedAddr->addr[4], par->getcurrtime());
	LOG(thisNode, stdstring);
}
